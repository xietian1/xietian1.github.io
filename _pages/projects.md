...
**5G/4G Privacy-exposing Identifiers Dissection** <br>
The first systematized and specification-grounded analysis of privacy-exposing identifiers in 5G and 4G networks, spanning NAS, RRC, MAC layers, and PC5 interface. <br>
<a href="{{ base_path }}/projects"><button class="btn btn--pdf">More</button></a>
